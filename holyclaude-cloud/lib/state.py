...
class Task:
    ...
    # Runtime fields
    status: str = "pending"
    target: str | None = None           # "local" | "cloud" | "local-model"
    ...
    # Local-model overflow: once a local-model attempt fails CI/review and is
    # re-dispatched, pin it to a real model so the 4B never re-grabs it.
    force_real_model: bool = False
